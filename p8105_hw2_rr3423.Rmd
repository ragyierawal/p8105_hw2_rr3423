...
* The variable names in the precipitation 2018 dataset are: `r names_p18`. 
* The total precipitation in 2018 was `r precipitation_18_total`.
* The median precipitation in 2018 was `r precipitation_19_total`.
* The number of rows in the precipitation 2018 dataset is `r p18_row`. 
* The number of columns in the precipitation 2018 dataset `r p18_col`. 

* The variable names in the precipitation 2019 dataset are: `r names_p19`. 
* The total precipitation in 2019 was `r precipitation_19_total`. 
* The median precipitation in 2019 was  `r p19_median`.
* The number of rows in the precipitation 2019 dataset is `r p19_row`. 
* The number of columns in the precipitation 2019 dataset is `r p19_col`. 
